...
function RestuarantCard({src, name , categories, price ,ratings, deliveryTime}) {
  return (
    <div className='w-[20vw] h-[50vh] bg-white border-2 rounded-lg mx-4 my-4 cursor-pointer scroll-smooth'>
