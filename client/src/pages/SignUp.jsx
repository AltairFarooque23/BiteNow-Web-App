  ...
  return (
    <div className="w-full h-[100vh] flex items-center">
        <div className="w-[40%] h-full flex flex-col items-center">
            ...
            <form action="" className='w-[68%] mt-12 flex flex-col items-center'>
            ...
            Already have an account <span className='text-green-500 decoration-green-500 underline cursor-pointer'>Sign in</span>
            </p>
        </div>
